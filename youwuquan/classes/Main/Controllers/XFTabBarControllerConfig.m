...
- (NSArray *)tabBarItemsAttributesForController {
    NSDictionary *firstTabBarItemsAttributes = @{
                                                 ...
                                                 CYLTabBarItemSelectedImage : @"tabbar_homeSelected", /* NSString and UIImage are supported*/
                                                 };
    NSDictionary *secondTabBarItemsAttributes = @{
                                                  CYLTabBarItemTitle : @"发现",
                                                  CYLTabBarItemImage : @"tabbar_find",
                                                  CYLTabBarItemSelectedImage : @"tabbar_findSelected",
                                                  };
    ...
    NSDictionary *fourthTabBarItemsAttributes = @{
                                                  ...
                                                  CYLTabBarItemSelectedImage : @"tabbar_mineSelected"
                                                  };
...
#warning CUSTOMIZE YOUR TABBAR APPEARANCE
    ...
    selectedAttrs[NSForegroundColorAttributeName] = kMainRedColor;
