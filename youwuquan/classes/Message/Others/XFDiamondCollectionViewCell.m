...
@interface XFDiamondCollectionViewCell ()
...
@implementation XFDiamondCollectionViewCell
...
- (void)setAutoLayout {
    ...
    XFDiamondMessageContent *content = (XFDiamondMessageContent *)self.model.content;

    if (content) {
//        self.textLabel.text = _textMessage.content;
    
        self.textLabel.text = @"小魂淡送你钻石啦";
...
//        messageContentViewRect.size.width = kScreenWidth;

        self.textLabel.text = @"你送小魂淡钻石啦";
