...
@interface XFWallImagePickerViewController () <UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation XFWallImagePickerViewController
...
- (void)setupNavigationBar {
    ...
    self.numberLabel.text = [NSString stringWithFormat:@"%zd/5张已选择",self.selectedNumber];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.selectedEnoughBlock = ^{
        ...
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"图片超限" message:@"只能选择5张" preferredStyle:(UIAlertControllerStyleAlert)];
    ...
    cell.selectedImageBlock = ^(BOOL isSelected, NSIndexPath *indexPath) {
        ...
        if (self.selectedIndexPaths.count + self.selectedNumber >= 5) {
