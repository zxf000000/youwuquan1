//
//  XFMyVideoStatusViewController.m
//  youwuquan
//
...
@interface XFMyVideoStatusViewController ()
<
...
@property (nonatomic,strong) UIImage *shotImage; // 视频封面


@end

@implementation XFMyVideoStatusViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    if (self.actionType == XFPLSActionTypePlayer) {
        // 播放器初始化
        [self initPlayer];
    ...
    if (self.actionType == XFPLSActionTypeGif) {
        // 演示 gif 动图
