...
-(void)setUpUI{
    ...
    self.leftIV.layer.cornerRadius = 10;
    ...
    self.centerIV.layer.cornerRadius = 10;
    ...
    self.rightIV.layer.cornerRadius = 10;
...
- (void)setInfoByCurrentImageIndex:(NSUInteger)currentImageIndex {
    ...
    if([self isHttpString:self.sourceDataArr[currentImageIndex]]){
        [self.centerIV setImageWithURL:[NSURL URLWithString:self.sourceDataArr[currentImageIndex]] placeholder:self.placeHolderImage];
    }else {
   ...
   if([self isHttpString:self.sourceDataArr[leftIndex]]){
        [self.leftIV setImageWithURL:[NSURL URLWithString:self.sourceDataArr[leftIndex]] placeholder:self.placeHolderImage];
    }else {
    ...
    if([self isHttpString:self.sourceDataArr[rightIndex]]){
        [self.rightIV setImageWithURL:[NSURL URLWithString:self.sourceDataArr[rightIndex]] placeholder:self.placeHolderImage];
    }else {
