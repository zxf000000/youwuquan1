        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (wself.loadImageCompletedBlock) {
                ...
                if (downloadedImage.images.count > 0) {
                    wself.currentPageImage = [LBPhotoBrowserManager defaultManager].lowGifMemory ? downloadedImage : [UIImage sdOverdue_animatedGIFWithData:UIImageJPEGRepresentation(image, 1)];
                }
            }
        });
    }];
